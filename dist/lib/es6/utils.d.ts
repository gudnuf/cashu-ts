...
declare function splitAmount(value: number, keyset: Keys, amountPreference?: Array<AmountPreference>, isDesc?: boolean): Array<number>;
declare function getDefaultAmountPreference(amount: number, keyset: Keys): Array<AmountPreference>;
...
declare function decodePaymentRequest(paymentRequest: string): PaymentRequest;
