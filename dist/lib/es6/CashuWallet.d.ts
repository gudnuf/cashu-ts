...
import { type AmountPreference, type MeltQuoteResponse, type MintKeys, type MeltTokensResponse, type Proof, type SendResponse, type Token, type TokenEntry, Preferences } from './model/types/index.js';
/**
