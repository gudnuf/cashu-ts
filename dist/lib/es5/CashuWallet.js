...
var dhke = __importStar(require("./DHKE.js"));
...
var CashuWallet = /** @class */ (function () {
    ...
    function CashuWallet(mint, options) {
        ...
        this._seed = (0, secrets_js_1.deriveSeedFromMnemonic)(options.mnemonicOrSeed);
    }
                ...
                switch (_c.label) {
                    case 0:
                        if (typeof token === 'string') {
                            decodedToken = (0, utils_js_1.cleanToken)((0, utils_js_1.getDecodedToken)(token)).token;
                        }
                        else {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        keys = _b.sent();
                        _a = this.createSplitPayload(amount, tokenEntry.proofs, keys, preference, options === null || options === void 0 ? void 0 : options.counter, options === null || options === void 0 ? void 0 : options.pubkey, options === null || options === void 0 ? void 0 : options.privkey), payload = _a.payload, blindedMessages = _a.blindedMessages;
     ...
     */
    CashuWallet.prototype.getMintQuote = function (amount) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    CashuWallet.prototype.getMeltQuote = function (invoice) {
        return __awaiter(this, void 0, void 0, function () {
            var meltQuote;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.mint.meltQuote({ unit: this._unit, request: invoice })];
                    case 1:
                        meltQuote = _a.sent();
     ...
     * @returns
     */
    CashuWallet.prototype.createSplitPayload = function (amount, proofsToSend, keyset, preference, counter, pubkey, privkey) {
    ...
    CashuWallet.prototype.createBlindedMessages = function (amounts, keysetId, counter, pubkey) {
        ...
        for (var i = 0; i < amounts.length; i++) {
            ...
            if (pubkey) {
                ...
                secretBytes = (0, secrets_js_1.deriveSecret)(this._seed, keysetId, counter + i);
                deterministicR = (0, utils_js_1.bytesToNumber)((0, secrets_js_1.deriveBlindingFactor)(this._seed, keysetId, counter + i));
            }
            else {
