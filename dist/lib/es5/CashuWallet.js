...
var cashu_ts_1 = require("./legacy/cashu-ts");
...
var CashuWallet = /** @class */ (function () {
    ...
    CashuWallet.prototype.receiveTokenEntry = function (tokenEntry, options) {
        return __awaiter(this, void 0, void 0, function () {
            var proofs, amount, preference, keys, pref, _a, payload, blindedMessages, signatures, newProofs;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        keys = _b.sent();
                        if (!preference) {
                            preference = (0, utils_js_1.getDefaultAmountPreference)(amount, keys);
                        }
                        pref = { sendPreference: preference };
                        _a = this.createSwapPayload(amount, tokenEntry.proofs, keys, pref, options === null || options === void 0 ? void 0 : options.counter, options === null || options === void 0 ? void 0 : options.pubkey, options === null || options === void 0 ? void 0 : options.privkey), payload = _a.payload, blindedMessages = _a.blindedMessages;
                ...
                switch (_d.label) {
                    case 0:
                        if (options === null || options === void 0 ? void 0 : options.preference) {
                            if ((0, cashu_ts_1.isAmountPreferenceArray)(options.preference)) {
                                options.preference = (0, cashu_ts_1.deprecatedAmountPreferences)(options.preference);
                            }
                            amount = (_a = options === null || options === void 0 ? void 0 : options.preference) === null || _a === void 0 ? void 0 : _a.sendPreference.reduce(function (acc, curr) { return acc + curr.amount * curr.count; }, 0);
                        }
                        return [4 /*yield*/, this.getKeys(options === null || options === void 0 ? void 0 : options.keysetId)];
                    case 1:
                        keyset = _d.sent();
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        validRs = rs.filter(function (_, i) {
    ...
    CashuWallet.prototype.mintTokens = function (amount, quote, options) {
        return __awaiter(this, void 0, void 0, function () {
            var keyset, _a, blindedMessages, secrets, rs, mintPayload, signatures;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getKeys(options === null || options === void 0 ? void 0 : options.keysetId)];
                    case 1:
                        keyset = _b.sent();
                        _a = this.createRandomBlindedMessages(amount, keyset, options === null || options === void 0 ? void 0 : options.preference, options === null || options === void 0 ? void 0 : options.counter, options === null || options === void 0 ? void 0 : options.pubkey), blindedMessages = _a.blindedMessages, secrets = _a.secrets, rs = _a.rs;
                        mintPayload = {
    ...
    CashuWallet.prototype.createSwapPayload = function (amount, proofsToSend, keyset, preference, counter, pubkey, privkey) {
        if ((0, cashu_ts_1.isAmountPreferenceArray)(preference)) {
            preference = (0, cashu_ts_1.deprecatedAmountPreferences)(preference);
        }
        var totalAmount = proofsToSend.reduce(function (total, curr) { return total + curr.amount; }, 0);
        var keepBlindedMessages = this.createRandomBlindedMessages(totalAmount - amount, keyset, preference === null || preference === void 0 ? void 0 : preference.keepPreference, counter);
        if (this._seed && counter) {
            counter = counter + keepBlindedMessages.secrets.length;
        }
        var sendBlindedMessages = this.createRandomBlindedMessages(amount, keyset, preference === null || preference === void 0 ? void 0 : preference.sendPreference, counter, pubkey);
        if (privkey) {
            proofsToSend = (0, NUT11_1.getSignedProofs)(proofsToSend.map(function (p) {
                return {
                    amount: p.amount,
     ...
     */
    CashuWallet.prototype.createRandomBlindedMessages = function (amount, keyset, amountPreference, counter, pubkey) {
        var amounts = (0, utils_js_1.splitAmount)(amount, keyset.keys, amountPreference);
