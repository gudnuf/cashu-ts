...
import { Keys, MintKeys, MintKeyset, Proof, Token } from './model/types/index.js';
/**
 ...
 */
export declare function getDecodedToken(tokenString: string, keysets?: MintKeyset[]): Token;
/**
 ...
 * @returns
 */
export declare function deriveKeysetId(keys: Keys, unit?: string, expiry?: number, versionByte?: 0 | 1): string;
