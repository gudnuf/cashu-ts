...
import { P2PKWitness, Proof } from '../../model/types/index.js';
 ...
 */
export declare function getP2PKExpectedKWitnessPubkeys(secretStr: string | Secret): Array<string>;
/**
 ...
 */
export declare function getP2PKWitnessPubkeys(secretStr: string | Secret): Array<string>;
/**
 ...
 * @returns {array} with the public keys or empty array
 */
export declare function getP2PKWitnessRefundkeys(secretStr: string | Secret): Array<string>;
/**
 ...
 */
export declare const getP2PKWitnessSignatures: (witness: string | P2PKWitness | undefined) => Array<string>;
/**
 ...
 */
export declare const signP2PKProofs: (proofs: Array<Proof>, privateKey: string | Array<string>, beStrict?: boolean) => Array<Proof>;
/**
